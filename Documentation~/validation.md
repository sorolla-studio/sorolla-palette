...
- [ ] Unity Android package name matches Google Play, Firebase, Facebook, AppLovin MAX, and Adjust.
- [ ] Unity iOS bundle ID matches App Store Connect, Firebase, Facebook, AppLovin MAX, and Adjust.
