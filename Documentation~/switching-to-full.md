...
| Revenue | Purchases can fan out to Adjust, Firebase, TikTok, GameAnalytics | Wire Unity IAP once if the game sells IAP |
...
| TikTok, if used | App ID: _______ / EM App ID: _______ | App ID: _______ / EM App ID: _______ |
...
| TikTok | Optional | `tiktokAppId`, `tiktokEmAppId`, `tiktokAccessToken` per platform |
