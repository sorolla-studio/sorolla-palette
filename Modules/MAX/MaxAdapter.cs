...
namespace SorollaPalette.MAX
{
    ...
    public static class MaxAdapter
    {
        ...
        private static void OnRewardedAdFailedToDisplay(string adUnitId, MaxSdkBase.ErrorInfo errorInfo,
        ...
        private static void OnRewardedAdReceivedReward(string adUnitId, MaxSdkBase.Reward reward,
            MaxSdkBase.AdInfo adInfo)
        {
        ...
        private static void OnRewardedAdRevenuePaid(string adUnitId, MaxSdkBase.AdInfo adInfo)
        {
            ...
            AdjustAdapter.TrackAdRevenue(adInfo);
#endif
        }
        ...
        private static void OnInterstitialAdFailedToDisplay(string adUnitId, MaxSdkBase.ErrorInfo errorInfo,
            MaxSdkBase.AdInfo adInfo)
        {
