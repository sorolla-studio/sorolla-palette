...
Per-game values moved to the private `sorolla-docs` repo: `~/workspace/sorolla-docs/platform/sdk/qa/games/{hungrysnake,sweepcollector,raftevolution}.md` (sweepcollector = "romba", raftevolution = "boat-runner"). Shared MAX SDK Key + AdMob publisher prefix in `qa/games/shared.md`.
