...
namespace Sorolla.Palette
{
    public static partial class Palette
    {
        ...
        ///
        ///     TxID dedup is enforced inside <c>TrackPurchase</c> itself, so duplicate callbacks from Google
        ///     Play or crash-replay cannot produce duplicate analytics events.
        /// </remarks>
